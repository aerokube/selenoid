...
| selenoid/firefox:48.0 | selenoid/vnc:firefox_48.0 | 1.3.9 | 0.13.0 | 48.0.2 (page load timeout, native events and proxies don't work) .12+<.^|
...
| selenoid/firefox:59.0 | selenoid/vnc:firefox_59.0 | 1.5.2 | 0.20.0 | 59.0.1
|===
...
| selenoid/chrome:65.0 | selenoid/vnc:chrome_65.0 | 2.37 | 65.0.3325.181
|===

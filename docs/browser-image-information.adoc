...
| selenoid/firefox:48.0 | selenoid/vnc:firefox_48.0 | 1.3.9 | 0.13.0 | 48.0.2 (page load timeout, native events and proxies don't work) .18+<.^|
...
| selenoid/chrome:72.0 | selenoid/vnc:chrome_72.0 | 2.45 | 72.0.3626.81
|===
...
| selenoid/opera:58.0 | selenoid/vnc:opera_58.0 | 2.42 | 58.0.3135.53
|===

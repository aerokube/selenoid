...
| selenoid/firefox:53.0 | selenoid/vnc:firefox_53.0 | 1.2.0 | 0.16.0 | 53.0 (switching windows may not work) 
| selenoid/firefox:54.0 | selenoid/vnc:firefox_54.0 | 1.3.1 | 0.17.0 | 54.0 (switching windows may not work) 
| selenoid/firefox:55.0 | selenoid/vnc:firefox_55.0 | 1.3.5 | 0.18.0 | 55.0.1 (switching windows may not work) 
|===

...
| selenoid/firefox:48.0 | selenoid/vnc:firefox_48.0 | 1.3.9 | 0.13.0 | 48.0.2 (page load timeout, native events and proxies don't work) .20+<.^|
...
| selenoid/chrome:74.0 | selenoid/vnc:chrome_74.0 | 74.0.3729.157 | 74.0.3729.6
| selenoid/chrome:75.0 | selenoid/vnc:chrome_75.0 | 75.0.3770.80 | 75.0.3770.8
|===

...
For <<Android>> containers there is an option to select emulator skin. List of available skins is:
...
For specifying exact skin you need to set *env* optional parameter by capabilities:

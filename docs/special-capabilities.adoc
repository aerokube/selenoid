...
For <<Android>> container there is option for specify emulator skin. List of availiable skins is:

----
HVGA  QVGA  WQVGA400  WQVGA432  WSVGA  WVGA800  WVGA854  WXGA720  WXGA800  WXGA800-7in
----

For specify exact skin you need to pass `env` parameter throw capabilities (i.e. Java):

----
.setCapability("env", new ArrayList<String>() { { add("SKIN=WXGA720"); } } );
----

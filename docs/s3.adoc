...
By default uploaded file name is preserved, i.e. S3 path is `/<session-id>.txt` or `/myCustomVideo.mp4`. You can optionally provide your custom key pattern using `-s3-key-pattern` flag and a set of placeholders:
